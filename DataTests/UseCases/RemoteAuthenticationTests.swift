...
final class RemoteAuthenticationTests: XCTestCase {
    ...
    func test_auth_shoud_call_httpClient_with_correct_url() {
        let url = makeUrl()
    ...
    func test_auth_shoud_call_httpClient_with_correct_data() {
    ...
    func test_auth_shoud_complete_with_error_if_client_completes_with_error() {
        let (sut, httpClientSpy) = makeSut()
    ...
    func test_auth_shoud_complete_with_expired_session_error_if_client_completes_with_unauthorized() {
        let (sut, httpClientSpy) = makeSut()
    ...
    func test_auth_shoud_complete_with_account_if_client_completes_with_valid_data() {
        let (sut, httpClientSpy) = makeSut()
    ...
    func test_auth_shoud_complete_with_error_if_client_completes_with_invalid_data() {
        let (sut, httpClientSpy) = makeSut()
        expect(sut, completeWith: .failure(.unexpected), when: {
    ...
    func test_auth_shoud_not_complete_if_sut_has_been_deallocated() {
