...
public final class ValidationBuilder {
    ...
    public func sameAs(_ fieldToCompare: String) -> ValidationBuilder {
        validations.append(CompareFieldsValidation(fieldName: fieldName, fieldNameToCompare: fieldToCompare, fieldLabel: fieldLabel))
        return self
    }
